...
/*   Updated: 2024/02/17 16:13:23 by gabo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * Si la pila tiene un solo elemento, se libera la memoria y se termina la función.
 * 
 * Si la pila tiene dos elementos, se intercambian y luego se libera la memoria.
 * 
 * Si la pila tiene tres elementos, se ordenan con la función "sort_3_numbers"
 * y luego se libera la memoria.
 * 
 * Si la pila tiene cuatro elementos, se ordenan con la función "sort_4_numbers".
 * 
 * Si la pila tiene más de cuatro elementos, se mueven los dos primeros elementos
 * a la pila B, se realiza la operación más barata con la función "cheapest",
 * se ordenan los tres primeros números de la pila A, finalmente
 * se realizan movimientos en la pila A con la función "moves_stack_a".
 * 
 * @param stacks Puntero a la estructura que contiene las pilas 'list_a' y 'list_b'.
 */
